...
namespace zadaci_2
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            // make readable bmpB
            await AES.AESCrypt(Constants.TestFilesPath + "B2B.bmp", key, Constants.Results_A3_2_FilesPath + "B2B_encr.bmp");
            await AES.AESDecrypt(Constants.Results_A3_2_FilesPath + "B2B_encr.bmp", key, Constants.Results_A3_2_FilesPath + "B2B_decrypted.bmp");
            ...
            // make readable bmpC
            await AES.AESCrypt(Constants.TestFilesPath + "B2C.bmp", key, Constants.Results_A3_2_FilesPath + "B2C_encr.bmp");
            await AES.AESDecrypt(Constants.Results_A3_2_FilesPath + "B2C_encr.bmp", key, Constants.Results_A3_2_FilesPath + "B2C_decrypted.bmp");
            ...
            // make readable bmpD
            await AES.AESCrypt(Constants.TestFilesPath + "B2D.bmp", key, Constants.Results_A3_2_FilesPath + "B2D_encr.bmp");
            await AES.AESDecrypt(Constants.Results_A3_2_FilesPath + "B2D_encr.bmp", key, Constants.Results_A3_2_FilesPath + "B2D_decrypted.bmp");
