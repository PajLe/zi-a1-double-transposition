...
namespace zadaci_2
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            // make readable bmpA
            await AES.AESCryptWithPCBC(Constants.TestFilesPath + "B2A.bmp", key, Constants.Results_A4_2_FilesPath + "B2A_encr.bmp");
            await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "B2A_encr.bmp", key, Constants.Results_A4_2_FilesPath + "B2A_decrypted.bmp");
            ...
            // make readable bmpB
            await AES.AESCryptWithPCBC(Constants.TestFilesPath + "B2B.bmp", key, Constants.Results_A4_2_FilesPath + "B2B_encr.bmp");
            await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "B2B_encr.bmp", key, Constants.Results_A4_2_FilesPath + "B2B_decrypted.bmp");
            ...
            // make readable bmpC
            await AES.AESCryptWithPCBC(Constants.TestFilesPath + "B2C.bmp", key, Constants.Results_A4_2_FilesPath + "B2C_encr.bmp");
            await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "B2C_encr.bmp", key, Constants.Results_A4_2_FilesPath + "B2C_decrypted.bmp");
            ...
            // make readable bmpD
            await AES.AESCryptWithPCBC(Constants.TestFilesPath + "B2D.bmp", key, Constants.Results_A4_2_FilesPath + "B2D_encr.bmp");
            await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "B2D_encr.bmp", key, Constants.Results_A4_2_FilesPath + "B2D_decrypted.bmp");
            ...
            await AES.AESCryptWithPCBC(Constants.TestFilesPath + "100MB.zip", key, Constants.Results_A4_2_FilesPath + "100MB_encrypted.zip");
            await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "100MB_encrypted.zip", key, Constants.Results_A4_2_FilesPath + "100MB_decrypted.zip");
            ...
            //await AES.AESCryptWithPCBC(Constants.TestFilesPath + "1GB.zip", key, Constants.Results_A4_2_FilesPath + "1GB_encrypted.zip");
            //await AES.AESDecryptWithPCBC(Constants.Results_A4_2_FilesPath + "1GB_encrypted.zip", key, Constants.Results_A4_2_FilesPath + "1GB_decrypted.zip");
